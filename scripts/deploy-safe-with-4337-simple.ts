/**
 * Deploy Safe with ERC-4337 - Simple approach
 * This script deploys a Safe 1/1 with ERC-4337 module using direct contract calls
 */
...
async function main() {
  console.log("=== Deploy Safe with ERC-4337 (Simple Approach) ===");
  ...
  try {
    console.log("1. Safe Factory Addresses...");
    
    // Safe Factory addresses for Sepolia (corrected checksums)
    const safeFactoryAddress = "0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67";
    const safeSingletonAddress = "0x41675C099F32341bf84BFc5382aF534df5C3341a";
    ...
    console.log("2. Creating Safe initialization data...");
    ...
    const safeSetupData = encodeFunctionData({
      ...
      args: [
        ...
        1n, // threshold
        "0x0000000000000000000000000000000000000000", // to (no contract call)
        "0x", // data (empty)
        safe4337ModuleAddress, // fallbackHandler (Safe4337Module)
        "0x0000000000000000000000000000000000000000", // paymentToken (none)
        0n, // payment (0)
        "0x0000000000000000000000000000000000000000" // paymentReceiver (none)
      ]
    });
    ...
    console.log("5. Extracting Safe address...");
    ...
    writeFileSync(
      'docs/deployed-safe-with-4337-simple.json', 
      JSON.stringify(deploymentInfo, null, 2)
    );

    writeFileSync(
      'docs/deployed-safe-with-4337-simple.txt', 
      safeAddress
    );

    console.log("✅ Deployment info saved!");
    console.log("  - JSON:", 'docs/deployed-safe-with-4337-simple.json');
    console.log("  - Address:", 'docs/deployed-safe-with-4337-simple.txt');
    console.log("");
