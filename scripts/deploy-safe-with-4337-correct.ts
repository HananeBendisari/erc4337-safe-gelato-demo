/**
 * Deploy Safe with ERC-4337 - Correct addresses
 * This script deploys a Safe 1/1 with ERC-4337 module using correct Sepolia addresses
 */
...
async function main() {
  console.log("=== Deploy Safe with ERC-4337 (Correct Addresses) ===");
  ...
  try {
    console.log("1. Safe Factory Addresses (Sepolia)...");
    
    // Safe Factory addresses for Sepolia (corrected)
    ...
    writeFileSync(
      'docs/deployed-safe-with-4337-correct.json', 
      JSON.stringify(deploymentInfo, null, 2)
    );

    writeFileSync(
      'docs/deployed-safe-with-4337-correct.txt', 
      safeAddress
    );

    console.log("✅ Deployment info saved!");
    console.log("  - JSON:", 'docs/deployed-safe-with-4337-correct.json');
    console.log("  - Address:", 'docs/deployed-safe-with-4337-correct.txt');
    console.log("");
