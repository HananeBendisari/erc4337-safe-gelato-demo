/**
 * Deploy Safe 1/1 with ERC-4337 Module - Manual Approach
 * Verify addresses and deploy using correct Safe infrastructure
 */
...
async function main() {
  console.log("=== Deploy Safe 1/1 with ERC-4337 Module (Manual) ===");
