/**
 * Native UserOperation using deployed Safe 1/1 with Gelato Smart Wallet SDK
...
async function main() {
  console.log("=== Safe 1/1 Native UserOperation with Gelato SDK ===");
  logNetworkInfo();
  ...
  console.log("");
  console.log("Status:");
  console.log("  Safe 1/1 Native UserOperation in progress");
