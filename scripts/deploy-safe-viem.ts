/**
 * Deploy Safe 1/1 with ERC-4337 Module - Viem Version
 */

import "dotenv/config";
import { createWalletClient, http, createPublicClient, getAddress, encodeFunctionData, parseEther } from "viem";
...
async function main() {
  console.log("=== Deploy Safe 1/1 with ERC-4337 Module (Viem) ===");
  ...
  try {
    ...
    // Safe Factory address on Sepolia
